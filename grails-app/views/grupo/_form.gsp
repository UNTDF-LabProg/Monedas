...
<div class="fieldcontain ${hasErrors(bean: grupoInstance, field: 'usuarios', 'error')} ">
  ...
  <g:select name="usuarios" from="${app.Usuario.list()}" multiple="multiple" optionKey="id" optionValue="nombre"  
            size="5" value="${grupoInstance?.usuarios*.nombre}" class="many-to-many"/>
</div>
